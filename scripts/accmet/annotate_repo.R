...
## Own computer ##
io$basedir <- "/Users/woodfin/Box/My_NMT-seq_work/Stephen/code/MCF7_matched-selected/"
...
io$in.sample_metadata <- paste0(io$basedir,"/sample_metadata.tsv")

## Options ##

# Valid chromosomes
opts$chr_list <- c(1:19,"X")
